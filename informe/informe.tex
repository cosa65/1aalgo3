...
\algoritmo{rondaOptima}{in/out rondaRes : tuple$<$Ronda int$>$,in/out exploradoras : Ronda,in amistades : bigSet}{res : string}{
  \Var{n : int}
  \complejidad{O(1)}
...
\\ \\
\noindent\makebox[\linewidth]{\rule{17cm}{0.4pt}}
\algoritmo{permutaciones}{in/out rondaRes : tuple$<$Ronda int$>$,in/out exploradoras : Ronda,in pos : int,in amistades : bigSet}{}{
